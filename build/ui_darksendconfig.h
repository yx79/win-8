...
public:
    ...
    void retranslateUi(QDialog *DarksendConfig)
    {
        ...
        label_2->setText(QApplication::translate("DarksendConfig", "Use 2 separate masternodes to mix funds up to 1000 8TH", nullptr));
        label_3->setText(QApplication::translate("DarksendConfig", "Use 8 separate masternodes to mix funds up to 1000 8TH", nullptr));
        label_4->setText(QApplication::translate("DarksendConfig", "Use 16 separate masternodes", nullptr));
        label_6->setText(QApplication::translate("DarksendConfig", "This option is the quickest and will cost about ~0.025 8TH to anonymize 1000 DEV", nullptr));
        label_7->setText(QApplication::translate("DarksendConfig", "This option is moderately fast and will cost about 0.05 8TH to anonymize 1000 DEV", nullptr));
        ...
        label_9->setText(QApplication::translate("DarksendConfig", "0.1 8TH per 1000 DEV you anonymize.", nullptr));
    } // retranslateUi
