...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelAnonymized->setText(QStringLiteral("0 8TH"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
...
#ifndef QT_NO_TOOLTIP
        labelDarksendSyncStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the EighthCoin network after a connection is established, but this process has not completed yet.", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 8TH / 0 Rounds", nullptr));
